/**
 * @file Parametros_globales.cpp
 *
 * @author Luciana Melina Luque
 *
 * @brief Implementation of global parameter configuration system for cancer simulation
 *
 * @details This file implements the parameter setting functionality for the simulation,
 *          providing a key-value based configuration system that supports loading
 *          various parameter types from configuration files.
 * 
 * Inbound dependencies "Parametros_globales.h", <string>
 *
...
/**
 * @brief Sets a specific global parameter to a provided value
 * @param parametro Name of the parameter to set
 * @param valor Value to assign to the parameter
 * 
 * @details This method provides a flexible mechanism to configure any global parameter
 *          from a string-based key-value pair. It handles type conversion based on the
 *          parameter's expected type (string, double, boolean, integer), and supports
 *          all configuration parameters defined in the Parametros_globales class.
 * 
 * @cancer_research This configuration system enables researchers to:
 *                 - Create standardized parameter sets for different cancer types
 *                 - Run comparative studies with controlled parameter variations
 *                 - Configure complex microenvironmental conditions specific to different tumors
 *                 - Set up immune response parameters for immunotherapy simulations
 *                 - Maintain reproducible simulation configurations
 */
